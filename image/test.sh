...
body="{\"endpoint\": \"http://zenko-cloudserver.default.svc.cluster.local:80\", \"credentials\": {\"accessKeyId\": \"${AWS_ACCESS_KEY_ID}\", \"secretAccessKey\": \"${AWS_SECRET_ACCESS_KEY}\" }, \"Bucket\": \"${TEST_BUCKET}\", \"Key\": \"test1.jpg\", \"tags\": {}, \"param\": \"rotate 90\"}"
echo $body
set -x
